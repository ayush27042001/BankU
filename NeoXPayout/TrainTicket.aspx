<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="TrainTicket.aspx.cs" Inherits="NeoXPayout.TrainTicket" %>
...
<div class="bnk-card-grid" style="margin:10px">
  ...
  <div class="bnk-card">
    ...
    <div class="bnk-card-title">Train Ticket Service Activation</div>
    <div class="bnk-card-desc">
      Enable Train Ticket Booking services at your outlet to help customers book, cancel, and manage railway tickets seamlessly.  
      With BankU Train Ticket Services, you can provide convenient ticketing solutions and enhance customer trust.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Book Train Tickets Instantly</li>
      <li>Support for Cancellations & Refunds</li>
      <li>PNR Status & Live Train Enquiry</li>
      <li>Secure & Hassle-Free Ticketing</li>
...
<div class="bnk-sidebar" id="sidebar1" >
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate Train Ticket Booking services and provide customers a reliable way to book railway tickets directly from your outlet.
  </p>

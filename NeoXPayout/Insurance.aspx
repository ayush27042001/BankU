<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="Insurance.aspx.cs" Inherits="NeoXPayout.Insurance" %>
...
<br> 
  ...
  <div class="bnk-card-grid" style="margin:10px">
     ...
     <div class="bnk-card">
        ...
        <div class="bnk-card-title">Insurance Service Activation</div>
        <div class="bnk-card-desc">
        Enable Insurance services at your outlet and help customers secure their future with trusted plans.  
        With BankU Insurance Service, you can offer protection solutions that provide peace of mind and financial security.
        </div>

        <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Offer Life, Health & General Insurance Plans</li>
        <li>Easy Policy Issuance & Renewal</li>
        <li>Secure and Reliable Claim Assistance</li>
        <li>Affordable Premiums with Flexible Options</li>
        <li>Help Customers Protect Their Families & Assets</li>
        </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Insurance Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    Activate Insurance services and provide customers with financial protection and security at your outlet.
  </p>

    <div class="bnk-alert-box">
      <strong>⚠️ Attention!</strong><br>
      ₹ 500 + 18% GST <br /> <b> Sub Total:- </b> 590.00 <span style="font-size: x-small;"> non-refundable fee</span>
    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Verifyotp.aspx.cs" Inherits="NeoXPayout.onboarding.Verifyotp" %>
                              ...
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex flex-column align-items-center ">
                                             ...
                                             <div class="mt-3 ">
                                                  <h6 class="text-capitalize text-center fw-bold">Hello <asp:Label ID="lblname" runat="server"></asp:Label>
                                                  </h6>
                                                  <span class="text-muted text-capitalize">
                                                       we send it to <asp:Label ID="lblmobileno" runat="server"></asp:Label>
                                                       
                                                  </span>
                                             </div>
                                             <div class="mt-3 w-100">
                                                  <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">your digit 4
                                                            code</label>
                                                      <asp:TextBox ID="txtotp" runat="server" placeholder="2-3-4-5" class="form-control" required=""></asp:TextBox>
                                                      
                                                  </div>
                                                  <div class="row my-3 g-3">
                                                       <div class="col-12">
                                                           <asp:LinkButton ID="LinkButton2" runat="server" class="btn btn-dark w-100" OnClick="LinkButton2_Click">Verify Mobile</asp:LinkButton>
                                                           
                                                          
                                                       </div>
                                                       <div class="col-sm-12 text-center d-flex justify-content-center">
                                                           <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" class="nav-link text-reverse fw-semibold text-decoration-underline">receive a code Re
                                                                 Send</asp:LinkButton>

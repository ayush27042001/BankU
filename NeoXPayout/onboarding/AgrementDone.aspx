<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgrementDone.aspx.cs" Inherits="NeoXPayout.onboarding.AgrementDone" %>
                              ...
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex flex-column align-items-center ">
                                             ...
                                             <div class="mt-3 ">
                                                  <h6 class="text-capitalize text-center fw-bold">Congratulation! Your Request Submited
                                                  </h6>
                                                 <p style="text-align:center">Please Wait For Approval, Onboarding team will verify and Call you In next 2 Working Hour</p>
                                                
                                                 <p style="text-align:center"><img src="success.jpeg" width="300px" /></p>
                                             </div>
                                             <%--<div class="mt-3 w-100">
                                                  <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">your digit 6
                                                            code</label>
                                                       <input type="email" class="form-control" id="exampleInputEmail1"
                                                            placeholder="2-3-4-5-8">
                                                  </div>
                                                  <div class="row my-3 g-3">
                                                       <div class="col-12">
                                                            <a href="index.html" class="btn btn-dark w-100">submite</a>
                                                       </div>
                                                       <div class="col-sm-12 text-center d-flex justify-content-center">
                                                            <a href="#"
                                                                 class="nav-link text-reverse fw-semibold text-decoration-underline">don't
                                                                 receive a code</a>
                                                            <a href="#"
                                                                 class="nav-link text-reverse fw-semibold text-decoration-underline ms-2">Re
                                                                 Send</a>
                                                       </div>
                                                  </div>
                                             </div>--%>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadFinalForm.aspx.cs" Inherits="NeoXPayout.onboarding.UploadFinalForm" %>
                              ...
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex flex-column align-items-center ">
                                             ...
                                             <div class="mt-3 ">
                                                  <h6 class="text-capitalize text-center fw-bold">Upload All Document
                                                  </h6>
                                                  <span class="text-muted text-capitalize">
                                                        Hello <asp:Label ID="Label1" runat="server"></asp:Label>, Please Upload All Document
                                             ...
                                             <div class="mt-3 w-100">
                                               ...
                                               <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">Udyam Registration Certificate</label>
                                                          <asp:FileUpload ID="FileUpload1" runat="server" class="form-control"/>
                                                      
                                                      
                                                  </div>
                                                 <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">GST Certificate</label>
                                                          <asp:FileUpload ID="FileUpload2" runat="server" class="form-control"/>
                                                      
                                                      
                                                  </div>
                                                 <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">Jio Tag Photo- 3 pic(in pdf)</label>
                                                          <asp:FileUpload ID="FileUpload3" runat="server" class="form-control"/>
                                                      
                                                      
                                                  </div>
                                                 <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">Passport Size Photo</label>
                                                          <asp:FileUpload ID="FileUpload4" runat="server" class="form-control"/>
                                                      
                                                      
                                                  </div>
                                                 <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">Registration Form Signed Copy <a href="BankU_KYC_Forms.pdf" target="_blank" style="color:red">(Download Reg Form)</a></label>

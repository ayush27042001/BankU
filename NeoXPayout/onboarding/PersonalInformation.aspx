<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonalInformation.aspx.cs" Inherits="NeoXPayout.onboarding.PersonalInformation" %>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 w-100 justify-content-center">
                         ...
                         <li class="nav-item mx-sm-3 after-erro d-flex">
                              <a class="nav-link active border rounded-5 px-3 ps-2 py-1 d-flex align-items-center my-2 my-sm-0"
                                   aria-current="page" href="#">
                                   <span class="border rounded-circle bg-pramary d-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24"
                                             fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                              ...
                              <div class="card">
                                   <div class="card-body">
                                        <div class="d-flex flex-column align-items-center ">
                                             ...
                                             <div class="mt-3 ">
                                                  <h6 class="text-capitalize text-center fw-bold">Personal Information
                                                  </h6>
                                                  <span class="text-muted text-capitalize">
                                                       Give Your Personal Information for registration
                                             ...
                                             <div class="mt-3 w-100">
                                                ...
                                                <div class="col-md-6">  <div class="mb-3">
                                                      ...
                                                      <asp:TextBox ID="txtfathername" runat="server" class="form-control" required="" placeholder="father's name"></asp:TextBox>
                                                      
                                                  </div></div>
                                                <div class="col-md-6">  <div class="mb-3">
                                                       <label for="exampleInputEmail1" class="form-label">Mother's Name</label>
                                                      <asp:TextBox ID="txtmothername" runat="server" class="form-control" required="" placeholder="Mother's name"></asp:TextBox>
                                                ...
                                                <div class="col-md-6">   <div class="mb-3">
                                                      ...
                                                      <asp:TextBox ID="txtdob" runat="server" class="form-control" required="" TextMode="Date" placeholder="YYYY-MM-DD"></asp:TextBox>
                                                ...
                                                <div class="col-md-6">  <div class="mb-3">
                                                   ...
                                                   <div class="mb-3">
                                                      ...
                                                      <asp:TextBox ID="txtaddress" runat="server" class="form-control" required="" placeholder="Address"></asp:TextBox>
                                                  ...
                                                  <div class="mb-3">
                                                      ...
                                                      <asp:TextBox ID="txtpincode" runat="server" class="form-control" required="" placeholder="000000" MaxLength="6"></asp:TextBox>
                                                      
                                                  </div>
                                                  <div class="row my-3 g-3">
                                                       <div class="col-12">
                                                           <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-dark w-100" OnClick="LinkButton1_Click">Submit</asp:LinkButton>
                                                           <%--<asp:Button ID="Button1" runat="server" Text="Submit" class="btn btn-dark w-100" OnClick="Button1_Click"/>--%>

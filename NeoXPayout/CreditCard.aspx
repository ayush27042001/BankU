<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="CreditCard.aspx.cs" Inherits="NeoXPayout.CreditCard" %>
...
<div class="bnk-card-grid" style="margin:10px">
  ...
  <div class="bnk-card">
    ...
    <div class="bnk-card-title">Credit Card Service Activation</div>
    <div class="bnk-card-desc">
      Enable Credit Card services at your outlet and help customers apply for and manage credit cards seamlessly.  
      With BankU Credit Card Service, you can provide customers with quick approvals, easy payments, and exciting rewards. 
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Instant credit card application processing</li>
      <li>Wide range of bank partners</li>
      <li>Attractive rewards & cashback offers</li>
      <li>Secure digital application process</li>
      <li>Quick approval & activation</li>
    </ul>
    ...
    <asp:Button 
      ...
      Text="Activate" 
      OnClientClick="openSidebar('Credit Card Service Activation'); return false;" />
  </div>
</div>
...
<div class="bnk-sidebar" id="sidebar1">
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate Credit Card services and enable your customers to apply and enjoy financial freedom with ease.
  </p>

<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="IntMoneyTransfer.aspx.cs" Inherits="NeoXPayout.IntMoneyTransfer" %>
...
<div class="bnk-card-grid" style="margin:10px">
  ...
  <%--<div class="bnk-card">
    ...
    <div class="bnk-card-desc">
      Enable International Money Transfer services at your outlet to help customers send and receive money across borders securely.
      With BankU International Transfer Services, you can expand your offerings, support global remittances, and build customer trust.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Send & Receive Money Globally</li>
      <li>Secure & Compliant Transactions</li>
      <li>Faster & Reliable Transfers</li>
      <li>Support Multiple Currencies</li>
      <li>Expand Services & Customer Base</li>
    </ul>

    <asp:Button ID="btnActivateInternational" runat="server"
  ...
  <div class="bnk-card">
    <div class="bnk-card-icon">🇳🇵</div>
    <div class="bnk-card-title">Nepal Money Transfer Activation</div>

    <div class="bnk-card-desc">
      Enable Nepal Money Transfer services at your outlet to help customers send and receive money between India and Nepal securely.
      With BankU Nepal Transfer Services, you can expand your offerings, support cross-border remittances, and build customer trust.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>India ↔ Nepal Money Transfer</li>
      <li>Secure & Compliant Transactions</li>
      <li>Faster & Reliable Transfers</li>
      <li>INR & NPR Currency Support</li>
      <li>Grow Local Customer Base</li>
    </ul>

    <asp:Button ID="btnActivateNepal" runat="server"
      CssClass="bnk-activate-btn"
      Text="Activate"
      OnClientClick="openSidebar('Nepal Money Transfer'); return false;" />
  </div>

  <!-- USA -->
  <div class="bnk-card">
    <div class="bnk-card-icon">🇺🇸</div>
    <div class="bnk-card-title">USA Money Transfer Activation</div>

    <div class="bnk-card-desc">
      Enable USA Money Transfer services at your outlet to help customers send money to the United States securely and efficiently.
      With BankU USA Transfer Services, you can expand your offerings, support international remittances, and build customer trust.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>India → USA Remittances</li>
      <li>Secure & Regulatory Compliant</li>
      <li>Fast Settlement & Tracking</li>
      <li>USD Currency Support</li>
      <li>Serve NRI & Global Customers</li>
    </ul>

    <asp:Button ID="btnActivateUSA" runat="server"
      CssClass="bnk-activate-btn"
      Text="Activate"
      OnClientClick="openSidebar('USA Money Transfer'); return false;" />
  </div>
...
<div class="bnk-sidebar" id="sidebar1" >
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate International Money Transfer services and provide customers a safe and secure way to send money abroad quickly.
  </p>
...
<script>
    function openSidebar(serviceType) {
        document.getElementById("bnk-sidebar-title").innerText = serviceType + " Activation";
        document.getElementById("sidebar1").classList.add("active");
        document.getElementById("<%= hdnServiceType.ClientID %>").value = serviceType;
    }

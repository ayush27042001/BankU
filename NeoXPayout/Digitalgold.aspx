<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="Digitalgold.aspx.cs" Inherits="NeoXPayout.Digitalgold" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="bnk-card-grid" style="margin:10px">
    ...
    <div class="bnk-card">
      ...
      <div class="bnk-card-title">Digital Gold Service Activation</div>
      <div class="bnk-card-desc">
        Enable Digital Gold services at your outlet and provide customers with a safe and easy way to buy, sell, and store 24K pure gold digitally. 
        With BankU Digital Gold, you can help customers invest in gold securely and conveniently.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Buy & sell 24K pure digital gold instantly</li>
        <li>Secure storage in insured vaults</li>
        <li>Start investing with as little as ₹10</li>
        <li>Real-time market-linked pricing</li>
        <li>Option to redeem in physical gold coins & bars</li>
      </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Digital Gold Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    <p style="margin-bottom: 10px; color: #555;">
     Activate Digital Gold services and enable your customers to invest, save, and grow their wealth securely.
    </p>

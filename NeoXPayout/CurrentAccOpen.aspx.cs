...
{
    public partial class CurrentAccOpen : System.Web.UI.Page
    {
            ...
            if (!IsPostBack) // only check on first load
            {
                ...
                using (SqlConnection con = new SqlConnection(cs))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(query, con))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@ServiceType", "Current Account Opening Activation");
                ...
                else
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(con))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(query, conn))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@TxnType", "Current Account Request");

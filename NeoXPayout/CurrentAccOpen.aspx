<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="CurrentAccOpen.aspx.cs" Inherits="NeoXPayout.CurrentAccOpen" %>
...
<div class="bnk-card-grid" style="margin:10px">
  ...
  <div class="bnk-card">
    ...
    <div class="bnk-card-title">Current Account Opening</div>
    <div class="bnk-card-desc">
      Open a Current Account for your business and enjoy seamless transactions, better fund management, and faster payments.  
      With BankU Current Accounts, manage your daily transactions with ease and flexibility.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Easy Current Account Opening</li>
      <li>Manage Business Transactions Seamlessly</li>
      <li>Quick Transfers & Payments</li>
      <li>Trusted & Secure Banking Experience</li>
      <li>Boost Business with Financial Flexibility</li>
    </ul>
    ...
    <asp:Button 
      ...
      Text="Activate" 
      OnClientClick="openSidebar('Current Account Opening'); return false;" />
  </div>
</div>
...
<div class="bnk-sidebar" id="sidebar1">
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate Current Account Opening services and provide customers with quick and easy access to business banking solutions.
  </p>

  <div class="bnk-alert-box">
    <strong>⚠️ Attention!</strong><br>
    ₹ 1,100 + 18% GST <br /> <b> Sub Total:- </b> 1,298.00
    <span style="font-size: x-small;"> non-refundable fee</span>
  </div>

  <label for="website-url">Enter Message</label>
  <asp:TextBox ID="txtUseCase" runat="server" Rows="4" 
    placeholder="Enter your Message" CssClass="form-control" />

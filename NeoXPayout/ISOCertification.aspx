<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="ISOCertification.aspx.cs" Inherits="NeoXPayout.ISOCertification" %>
...
<br> 
  ...
  <div class="bnk-card-grid" style="margin:10px">
    ...
    <div class="bnk-card">
      ...
      <div class="bnk-card-title">ISO Certification Service Activation</div>
      <div class="bnk-card-desc">
        Enable ISO Certification services at your outlet and help businesses achieve globally recognized quality and compliance standards. 
        With BankU ISO Certification, you can guide organizations toward improved credibility, efficiency, and customer trust.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Assistance with ISO application & documentation</li>
        <li>Guidance for ISO 9001, 14001, 27001, and more</li>
        <li>Boosts business credibility and trust</li>
        <li>Improves operational efficiency & compliance</li>
  ...
  <div class="bnk-sidebar" id="sidebar1" >
   ...
   <p style="margin-bottom: 10px; color: #555;">
    Activate ISO Certification services and help businesses gain global recognition and compliance standards.
  </p>

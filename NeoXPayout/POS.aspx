<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="POS.aspx.cs" Inherits="NeoXPayout.POS" %>
...
<br> 
  ...
  <div class="bnk-card-grid" style="margin:10px">
     ...
     <div class="bnk-card">
      ...
      <div class="bnk-card-title">POS Service Activation</div>
      <div class="bnk-card-desc">
        Enable Point-of-Sale (POS) services at your outlet and start accepting secure card payments. 
        With BankU POS, you can offer customers a seamless digital payment experience and grow your business.
      </div>
  
      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Accept Debit & Credit Card Payments</li>
        <li>Instant Settlement to Linked Bank Account</li>
        <li>Secure Transactions with PCI-DSS Compliance</li>
        <li>Support for Contactless & Chip Cards</li>
        <li>Increase Footfall with Digital Payment Acceptance</li>
      </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('POS Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    <p style="margin-bottom: 10px; color: #555;">Activate POS services and start accepting card payments at your outlet.</p>

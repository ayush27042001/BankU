<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="EMPuser.aspx.cs" Inherits="NeoXPayout.EMPuser" %>
...
<br> 
  ...
  <div class="bnk-card-grid" style="margin:10px">
     ...
     <div class="bnk-card">
      ...
      <div class="bnk-card-title">EMP Service Activation</div>
      <div class="bnk-card-desc">
        Enable Employee (EMP) services to manage staff access, roles, and permissions.  
        With BankU EMP, you can streamline workforce management and ensure secure handling of business operations.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Create & Manage Employee Profiles</li>
        <li>Assign Roles and Access Permissions</li>
        <li>Track Employee Activities & Reports</li>
        <li>Secure Login with Multi-Level Authentication</li>
        <li>Improve Efficiency with Centralized Management</li>
      </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('EMP Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    Activate EMP services to simplify employee management and strengthen business operations.
  </p>

<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="CreditCheck.aspx.cs" Inherits="NeoXPayout.CreditCheck" %>
...
<div class="bnk-card-grid" style="margin:10px">
  ...
  <div class="bnk-card">
    ...
    <div class="bnk-card-title">Credit Check Service Activation</div>
    <div class="bnk-card-desc">
      Enable Credit Check services at your outlet to help customers verify their credit profile before financial decisions.  
      With BankU Credit Check Services, you can provide reliable credit reports, empower financial planning, and build trust with your customers.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Instant Credit Score Access</li>
      <li>Secure & Accurate Credit Reports</li>
      <li>Support for Loan & Financial Applications</li>
      <li>Boost Customer Financial Awareness</li>
      <li>Build Trust with Transparent Insights</li>
    </ul>
    ...
    <asp:Button 
      ...
      Text="Activate" 
      OnClientClick="openSidebar('Credit Check Service Activation'); return false;" />
  </div>
</div>
...
<div class="bnk-sidebar" id="sidebar1">
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate Credit Check services and give your customers instant access to their credit profile, helping them make informed financial decisions with confidence.
  </p>

  <div class="bnk-alert-box">
    <strong>⚠️ Attention!</strong><br>
    ₹ 500 + 18% GST <br /> 
    <b> Sub Total:- </b> 590.00 
  ...
  <div class="simple-modal">
    ...
    <div class="simple-modal-body text-center">
      ...
      <p class="fw-bold text-danger mb-2">
        ₹ 590 (including GST) will be deducted from your account.
      </p>

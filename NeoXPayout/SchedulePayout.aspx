<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="SchedulePayout.aspx.cs" Inherits="NeoXPayout.SchedulePayout" %>
...
<div class="bnk-card-grid" style="margin:10px">
   ...
   <div class="bnk-card">
      ...
      <div class="bnk-card-title">Schedule Payout Service Activation</div>
      <div class="bnk-card-desc">
        Enable Schedule Payout services at your outlet and automate fund transfers on specific dates and times. 
        With BankU Schedule Payout Service, you can plan and execute recurring payments such as salaries, vendor bills, or EMI collections with ease.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Automate payouts on scheduled dates and times</li>
        <li>Supports recurring and one-time scheduled transfers</li>
        <li>Reduces manual effort and ensures timely payments</li>
        <li>Improve financial planning and cash flow management</li>
        <li>Enhance reliability with consistent, on-time settlements</li>
      </ul>
      ...
      <asp:Button 
        ...
        Text="Activate" 
        OnClientClick="openSidebar('Schedule Payout Service Activation'); return false;" />
   </div>
</div>
...
<div class="bnk-sidebar" id="sidebar1">
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate Schedule Payout services and start automating fund transfers for your business and customers.
  </p>

  <div class="bnk-alert-box">
    <strong>⚠️ Attention!</strong><br>
    ₹ 12,000 + 18% GST <br /> <b> Sub Total:- </b> 14,160.00 <span style="font-size: x-small;"> non-refundable fee</span>
  </div>

  <label for="website-url">Enter Use Case</label>
  <asp:TextBox ID="txtUseCase" runat="server" Rows="4" placeholder="Explain your Schedule Payout use case" CssClass="form-control" />
  ...
  <div class="bnk-sidebar-footer">
      ...
      <a href="#">View Schedule Payout Business Model</a>
  </div>
</div>

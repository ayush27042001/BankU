<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="Logistics.aspx.cs" Inherits="NeoXPayout.Logistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="bnk-card-title">Logistics Service Activation</div>
  <div class="bnk-card-desc">
    Enable Logistics services at your outlet and manage deliveries with ease. 
    With BankU Logistics, you can streamline shipments, track parcels in real-time, and ensure faster customer delivery.
  </div>

  <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
    <li>Doorstep pickup & delivery of parcels</li>
    <li>Real-time shipment tracking</li>
    <li>Affordable and reliable courier solutions</li>
    <li>Wide coverage across cities & towns</li>
    <li>Boost customer satisfaction with faster delivery</li>
  </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Logistics Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    Activate Logistics services and start offering reliable delivery solutions to your customers.
  </p>

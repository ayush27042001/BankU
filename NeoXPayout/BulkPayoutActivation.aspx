<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="BulkPayoutActivation.aspx.cs" Inherits="NeoXPayout.BulkPayoutActivation" %>
...
<div class="bnk-card-grid" style="margin:10px">
   ...
   <div class="bnk-card">
      ...
      <div class="bnk-card-title">Bulk Payout Service Activation</div>
      <div class="bnk-card-desc">
        Enable Bulk Payout services at your outlet and transfer funds instantly to multiple beneficiaries in one go.
        With BankU Bulk Payout Service, you can simplify vendor payments, employee salaries, and customer refunds quickly and securely.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Make instant bulk transfers to multiple accounts</li>
        <li>Supports IMPS/NEFT/RTGS modes</li>
        <li>Track and manage payouts in real-time</li>
        <li>Reduce operational effort and save time</li>
        <li>Enhance business trust with faster settlements</li>
      </ul>
      ...
      <asp:Button 
        ...
        Text="Activate" 
        OnClientClick="openSidebar('Bulk Payout Service Activation'); return false;" />
   </div>
</div>
...
<div class="bnk-sidebar" id="sidebar1">
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate Bulk Payout services and start offering seamless large-scale fund transfers to your customers.
  </p>
  ...
  <asp:TextBox ID="txtUseCase" runat="server" Rows="4" placeholder="Explain your Bulk Payout use case" CssClass="form-control" />
  ...
  <div class="bnk-sidebar-footer">
      ...
      <a href="#">View Bulk Payout Business Model</a>
  </div>
</div>

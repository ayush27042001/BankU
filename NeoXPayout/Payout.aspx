      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="singlePayoutSidebar" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="offcanvas-body">
                ...
                <div class="mb-3 d-flex gap-2">
                    ...
                    <button type="button" class="method-btn" data-method="upi">
                        <i class="bi bi-upc-scan"></i> UPI
                    </button>
                   <%-- <button type="button" class="method-btn" data-method="wallet">
               ...
               <div class="method-content" id="bank">
                    ...
                    <div class="mb-3">
                        <asp:TextBox ID="txtBene" runat="server" CssClass="form-control" placeholder="Beneficiary Name"></asp:TextBox>
                    ...
                    <div class="mb-4">
                        ...
                        <asp:ListItem Value="PNB">Punjab National Bank</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <asp:LinkButton runat="server" CssClass="btn btn-primary w-100" Style="background-color:#6e007c"

<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="Announcement.aspx.cs" Inherits="NeoXPayout.Announcement" %>
...
<br> 
  ...
  <div class="bnk-card-title">Announcement Service Activation</div>
  <div class="bnk-card-desc">
    Enable Announcement services at your outlet and keep your customers informed in real time. 
    With BankU Announcement Service, you can share important updates, offers, and alerts instantly.
  </div>

  <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
    <li>Broadcast important messages to customers</li>
    <li>Promote new products, services, and offers</li>
    <li>Instant updates on outlet events or changes</li>
    <li>Clear voice or digital display announcements</li>
    <li>Improve customer engagement & communication</li>
  </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Announcement Service Activation'); return false;" />

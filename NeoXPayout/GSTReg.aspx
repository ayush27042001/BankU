<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="GSTReg.aspx.cs" Inherits="NeoXPayout.GSTReg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="bnk-card-grid" style="margin:10px">
     ...
     <div class="bnk-card">
      ...
      <div class="bnk-card-title">GST Registration Service Activation</div>
      <div class="bnk-card-desc">
        Enable GST Registration services at your outlet and help businesses comply with taxation laws. 
        With BankU GST services, you can simplify the registration process and support businesses in becoming GST compliant.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Assistance with new GST registration</li>
        <li>Filing and documentation support</li>
        <li>Guidance on GST rules and compliance</li>
        <li>Faster and hassle-free registration process</li>
        <li>Enable businesses to claim input tax credits</li>
      </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('GST Reg Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    <h3 id="bnk-sidebar-title"></h3>
     <p style="margin-bottom: 10px; color: #555;">
        Activate GST Registration services and help businesses stay tax compliant with ease.
      </p>

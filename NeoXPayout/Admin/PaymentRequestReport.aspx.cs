...
{
    public partial class PaymentRequestReport : System.Web.UI.Page
    {
        ...
        {
            string query = "select * from  Wlpaymentrequest where Wlid=@Wlid and Reqdate>=@TimeStampFrom and Reqdate<=@TimeStamp order by Id desc";
            ...
            mcom.Parameters.AddWithValue("@Wlid", this.Session["AdminNeoxUID"].ToString());

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="DistUser.aspx.cs" Inherits="NeoXPayout.Admin.DistUser" %>
...
<h3 class="mt-4 mb-3 fw-bold" style="color:#2c3e50; font-family:'Segoe UI', Tahoma, sans-serif; margin-left:20px;">
  Search User Added By Distributor
</h3>
...
<%--<div class="d-flex flex-wrap gap-3 align-items-center mb-3" style="margin-left:20px; margin-right:20px;">
    ...
    <asp:DropDownList runat="server" ID="ddlDist" CssClass="form-control text-dark"  style="max-width:200px;">
        <asp:ListItem Text="Select Type of Business" Value="" />
		<asp:ListItem Text="Proprietorship" Value="Proprietorship" />
    </asp:DropDownList>
    <asp:LinkButton runat="server" ID="btnSearch" CssClass="btn "  style="max-width:200px;  background-color:purple; color:white" OnClick="btnSearch_Click">Search</asp:LinkButton>
</div>--%>

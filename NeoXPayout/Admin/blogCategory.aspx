<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="blogCategory.aspx.cs" Inherits="NeoXPayout.Admin.blogCategory" %>
		...
		<div class="col-md-12">
			...
			<div class="card mb-4">
				<div class="card-header py-3 bg-transparent border-bottom-0">
					<h6 class="card-title mb-0"><strong>Blogs Category</strong></h6>
				...
				<div class="card-body card-main-one">
						...
						<div class="row">
							...
							<div class="col-12">
                                <asp:LinkButton ID="btnAdd" runat="server" class="btn btn-primary" ValidationGroup="AddApi" style="background-color:purple" OnClick="btnAdd_Click">Add Category</asp:LinkButton>
							</div>
						</div>
                        ...
                        <ItemTemplate>
                                <tr >
                                    ...
                                    <td><%# Eval("Status") %></td>
                                      ...
                                      <td><a href="editCategory.aspx?id=<%# Eval("Id") %>" class="btn btn-danger">Edit</a></td> 

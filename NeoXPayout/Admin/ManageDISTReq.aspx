<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="ManageDISTReq.aspx.cs" Inherits="NeoXPayout.Admin.ManageDISTReq" %>
                ...
                <ItemTemplate>
                    <div class="d-flex gap-2">
                        ...
                        <asp:Button ID="btnUpdate" runat="server" Text="Update" CommandName="UpdateStatus"
                            CommandArgument='<%# Eval("Id") + "|" + Eval("UserId") + "|" + Eval("ReqId") +"|" + Eval("Title") %>' CssClass="btn btn-sm px-3" style="background-color:#6e007c; color:white" />
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>

...
namespace NeoXPayout.Admin
{
    public partial class ViewServiceProvider : System.Web.UI.Page
    {
        ...
        protected void gvRequests_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                con.Open();
                string query = @"UPDATE SERVICE_PROVIDER SET ProviderCode = @ProviderCode, ServiceCode = @ServiceCode,  IsEnabled = @IsEnabled WHERE Id = @Id";
        ...
        protected void gvRequests_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                con.Open();
                string query = "DELETE FROM SERVICE_PROVIDER WHERE Id = @Id";

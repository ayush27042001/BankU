...
{
    public partial class ViewAPIDocument : System.Web.UI.Page
    {
        ...
        private void LoadRequests()
        {
            ...
            {
                string query = "SELECT * FROM APIDocument";
        ...
        protected void gvRequests_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            if (e.CommandName == "UpdateStatus")
            {
                ...
                using (SqlConnection con = new SqlConnection(connStr))
                {
                    ...
                    string updateQuery = "UPDATE APIDocument SET Status = @Status WHERE Id = @Id";

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="ViewFeatureMap.aspx.cs" Inherits="NeoXPayout.Admin.ViewFeatureMap" %>
...
<script>
    ...
    document.getElementById("statusFilter").addEventListener("change", function () {
        ...
        rows.forEach(function (row) {
            var statusCell = row.cells[3]?.innerText.toLowerCase(); 

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="DebitCredit.aspx.cs" Inherits="NeoXPayout.Admin.DebitCredit" %>
			...
			<div class="px-xl-5 px-lg-4 px-3 py-2 page-header">
				<div class="col-sm-6 ">
					<ol class="breadcrumb mb-0 bg-transparent ">
						...
						<li class="breadcrumb-item active" aria-current="page" title="Widgets Forms">Debit /Credit</li>
					</ol>
				</div>
			</div>
					...
					<div class="col-md-12">
						...
						<div class="card mb-4">
							<div class="card-header py-3 bg-transparent border-bottom-0">
								<h6 class="card-title mb-0"><strong>Debit/ Credti</strong></h6>
							...
							<div class="card-body card-main-one">
									...
									<div class="row">
										...
										<div class="mb-3 col-md-6 col-12">
											...
											<fieldset class="form-icon-group left-icon position-relative">
												<asp:TextBox ID="txtfullname" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
												<div class="form-icon position-absolute">
													<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
														fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
														<path

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="ProfileRequest.aspx.cs" Inherits="NeoXPayout.Admin.ProfileRequest" %>
...
<div class="table-responsive" style="margin-left:20px; margin-right:20px; margin-top:20px;border-radius:7px">
    <asp:GridView ID="gvRequests" runat="server" AutoGenerateColumns="False" DataKeyNames="RequestId"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DetailType" HeaderText="Title" />
            <asp:BoundField DataField="RequestStatus" HeaderText="Current Status" />
                ...
                <ItemTemplate>
                    <div class="d-flex gap-2">
                        ...
                        <asp:Button ID="btnUpdate" runat="server" Text="Update" CommandName="UpdateStatus"
                             CommandArgument='<%# Eval("RequestId")+ "|" + Eval("UserId") + "|" + Eval("DetailType") +"|" + Eval("NewValue")%>' CssClass="btn btn-sm px-3" 

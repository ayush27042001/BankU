<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="ViewAPIDocument.aspx.cs" Inherits="NeoXPayout.Admin.ViewAPIDocument" %>
    ...
    <asp:GridView ID="gvRequests" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Description">
                <ItemTemplate>
                    <span class="truncate-text" title='<%# Eval("Discription") %>'>
                        <%# Eval("Discription") %>
                    </span>
                    <button type="button" class="btn btn-link p-0 ms-2 text-primary copy-btn" 
                        data-text='<%# Eval("Discription") %>' title="Copy">
            ...
            <asp:TemplateField HeaderText="Update Status">
              ...
              <asp:TemplateField HeaderText="Actions">
                <ItemTemplate>
                    <div class="d-flex gap-2">
                       <a href="EditAPIDocument.aspx?id=<%# Eval("Id") %>" class="btn btn-danger">Edit</a>                     
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>

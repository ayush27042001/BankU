<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="WebsiteRequest.aspx.cs" Inherits="NeoXPayout.Admin.WebsiteRequest" %>
...
<div class="table-responsive" style="margin-left:20px; margin-right:20px; margin-top:20px;border-radius:7px">
    <asp:GridView ID="gvRequests" runat="server" AutoGenerateColumns="False" DataKeyNames="CompanyId"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="CompanyNumber" HeaderText="Company Number" />
                ...
                <ItemTemplate>
                    <div class="d-flex gap-2">
                        ...
                        <asp:Button ID="btnUpdate" runat="server" Text="Update" CommandName="UpdateStatus"
                            CommandArgument='<%# Eval("CompanyId") %>' CssClass="btn btn-sm px-3" style="background-color:#6e007c; color:white" />
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>

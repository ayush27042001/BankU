<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="ViewMasterProvider.aspx.cs" Inherits="NeoXPayout.Admin.ViewMasterProvider" %>
        ...
        <asp:TemplateField HeaderText="Provider Name">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtProviderName" runat="server"
                    Text='<%# Bind("ProviderName") %>' CssClass="form-control form-control-sm" />
            </EditItemTemplate>
        </asp:TemplateField>

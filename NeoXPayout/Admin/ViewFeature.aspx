<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="ViewFeature.aspx.cs" Inherits="NeoXPayout.Admin.ViewFeature" %>
...
<div class="table-responsive" style="margin-left:20px; margin-right:20px; margin-top:20px;border-radius:7px">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Feature Code">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtFeatureCode" runat="server"
                    Text='<%# Bind("FeatureCode") %>' CssClass="form-control form-control-sm" />
            </EditItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Config">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtExtraConfig" runat="server"
                    Text='<%# Bind("ExtraConfig") %>' CssClass="form-control form-control-sm" />
            </EditItemTemplate>
        </asp:TemplateField>

           <asp:TemplateField HeaderText="FeatureName">
            <ItemTemplate>
                <%# Eval("FeatureName") %>
            </ItemTemplate>
            <EditItemTemplate>
                <asp:TextBox ID="FeatureName" runat="server"
                    Text='<%# Bind("FeatureName") %>' CssClass="form-control form-control-sm" />
            </EditItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Display Order">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtDisplayOrder" runat="server"
                    Text='<%# Bind("DisplayOrder") %>' CssClass="form-control form-control-sm" />
            </EditItemTemplate>
        </asp:TemplateField>

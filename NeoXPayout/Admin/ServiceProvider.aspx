<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NeoxAdmin.Master" AutoEventWireup="true" CodeBehind="ServiceProvider.aspx.cs" Inherits="NeoXPayout.Admin.ServiceProvider" %>
        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-header py-3 bg-transparent border-bottom-0">
                    <h6 class="card-title mb-0"><strong>Add Service Provider</strong></h6>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg rounded-3 text-center">
         ...
         <div class="modal-header text-white border-0" style="background-color:purple;">
            <h5 class="modal-title w-100" id="successModalLabel">Service Provider Added Successfully</h5>
          ...
          <div class="modal-body">
            ...
            <h6 class="fw-semibold">Your Service Provider has been added successfully!</h6>

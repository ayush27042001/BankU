<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="AyushmanCard.aspx.cs" Inherits="NeoXPayout.AyushmanCard" %>
...
<div class="bnk-card-grid" style="margin:10px">
  ...
  <div class="bnk-card">
    ...
    <div class="bnk-card-title">Ayushman Card Service Activation</div>
    <div class="bnk-card-desc">
      Enable Ayushman Bharat Health Card services at your outlet to help customers apply, download, and manage their Ayushman cards seamlessly.  
      With BankU Ayushman Services, you can provide affordable healthcare access and build trust with your customers.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Apply for New Ayushman Bharat Cards</li>
      <li>Download & Print Ayushman Cards</li>
      <li>Verify Eligibility of Beneficiaries</li>
      <li>Support for Lost / Duplicate Card Requests</li>
...
<div class="bnk-sidebar" id="sidebar1" >
  ...
  <p style="margin-bottom: 10px; color: #555;">
    Activate Ayushman Bharat Health Card services and provide customers an easy way to access affordable healthcare benefits under PM-JAY.
  </p>

  <div class="bnk-alert-box">
    <strong>⚠️ Attention!</strong><br>
    ₹ 7,500 + 18% GST <br /> <b> Sub Total:- </b> 8,850.00 <span style="font-size: x-small;"> non-refundable fee</span>
  </div>

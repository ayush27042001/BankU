<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="BusinessLoan.aspx.cs" Inherits="NeoXPayout.BusinessLoan" %>
...
<br> 
  ...
  <div class="bnk-card-grid" style="margin:10px">
    ...
    <div class="bnk-card">
      ...
      <div class="bnk-card-title">Business Loan Service Activation</div>
      <div class="bnk-card-desc">
        Enable Business Loan services at your outlet and help entrepreneurs get access to quick and reliable funding.  
        With BankU Business Loans, you can support businesses in expanding operations and achieving growth.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Provide Loans for Small & Medium Enterprises</li>
        <li>Quick Loan Application & Approval Process</li>
        <li>Flexible Repayment Options</li>
        <li>Competitive Interest Rates</li>
        <li>Support Business Growth & Expansion</li>
      </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Business Loan Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    Activate Business Loan services and help local businesses achieve financial growth.
  </p>
  

    <div class="bnk-alert-box">
      <strong>⚠️ Attention!</strong><br>
      ₹ 2,500 + 18% GST <br /> <b> Sub Total:- </b> 2,950.00 <span style="font-size: x-small;"> non-refundable fee</span>
    </div>
  ...
  <div class="simple-modal">
    ...
    <div class="simple-modal-body text-center">
      ...
      <p class="fw-bold text-danger mb-2">
        ₹2,950 (including GST) will be deducted from your account.
      </p>

    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .row.mb-3 {
                ...
                .row.mb-3 select, .row.mb-3 input {
                    width: 100% !important;
            ...
            .btn-primary.w-100, .btn.btn-primary {
                position: fixed;
                bottom: 10px;
                left: 10px;
                right: 10px;
        ...
        .finger-card {
            ...
            .finger-card input {
                ...
                .finger-card input:checked + img + span, .finger-card input:checked + img {
                    font-weight: 600;
                }

                .finger-card input:checked ~ span, .finger-card input:checked ~ img {
                    border-color: #6a1b9a;
                }

            .finger-card:has(input:checked) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="col text-end">
                            ...
                            <div class="sender-profile d-flex align-items-center ms-3" style="display: none !important">
                                ...
                                <div class="ms-2 text-start">
                                    <div id="SenderName" class="sender-name"></div>
                                    <div class="sender-subtitle">Verified Agent</div>
                                </div>
                            </div>
    ...
    <asp:HiddenField ID="hdnUserMobile" runat="server" />
    <asp:HiddenField ID="hdnUserPAN" runat="server" />
    <asp:HiddenField ID="hdnUserBankAccount" runat="server" />
    <asp:HiddenField ID="hdnUserBankIFSC" runat="server" />
        ...
        <div class="offcanvas-body p-4">
            ...
            <div class="mt-4">
                ...
                <div class="fingerprint-box">
                    ...
                    <label class="finger-card" onclick="selectDeviceBtn('Morpho', this)">
                        <input type="radio" name="fingerDevice" value="MORPHO">
                        <img src="assets/images/morpho.png" height="45">
                        <span>Morpho L1</span>
                    </label>

                    <label class="finger-card" onclick="selectDeviceBtn('Mantra', this)">
                        <input type="radio" name="fingerDevice" value="MANTRA">
                        <img src="assets/images/mantra.png" height="45">
                        <span>Mantra L1</span>
                    </label>

                    <label class="finger-card" onclick="selectDeviceBtn('Startek', this)">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="aepsRegisterModal"
        ...
        <div class="offcanvas-body p-4">
            <div id="Signinprevalidate">

                <div class="mb-3">
                    <label class="form-label fw-semibold">Aadhar Number</label>
                    <input type="text" id="aadharNoReg" class="form-control" placeholder="Enter Aadhar Number" maxlength="12">
                    <small class="text-danger d-none" id="erraadharNoReg">Invalid Aadhar Number</small>
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold">Mobile Number</label>
                    <input type="text" id="regMobile" placeholder="Enter Mobile Number" class="form-control">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="bankAccountNumber" placeholder="Enter Bank Account" class="form-control">
                    <small class="text-danger d-none" id="errbankAccountNumber">Required field</small>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-semibold">Bank IFSC Code</label>
                    <input type="text" id="BankIFSCCode" placeholder="Enter IFSC Code" class="form-control">
                    <small class="text-danger d-none" id="errBankIFSCCode">Required field</small>
                </div>

            </div>

            <div id="signinpostvalidate" style="display: none">
                <div class="mb-3">
                    <label class="form-label fw-semibold">OTP</label>
                    <input type="text" id="signinOTP" placeholder="Enter Valid OTP" class="form-control">
                    <small class="text-danger d-none" id="errsigninOTP">Required field</small>
                </div>
            </div>
            <div class="d-flex justify-content-between mt-4">
                <button class="btn text-white px-4" id="btnCreateAgent"
                ...
                <button class="btn text-white px-4" id="btnValidateAgent"
                    style="background: purple; display: none"
                    type="button"
                    onclick="validateSigninOTP()">
                    ✔ Validate Agent
                </button>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="aepsEKYCModel"
        data-bs-backdrop="static" data-bs-keyboard="false">

        <div class="offcanvas-header text-white" style="background: purple;">
            <div>
                <h5 class="mb-0 fw-bold">BankU</h5>
                <small>AEPS EKYC</small>
            </div>
        ...
        <div class="offcanvas-body p-4">
            ...
            <div class="">
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold">Aadhar Number</label>
                    <input type="text" id="aadharNoKYC" class="form-control" placeholder="Enter Aadhar Number" maxlength="12">
                    <small class="text-danger d-none" id="erraadharNoKYC">Invalid Aadhar Number</small>
                </div>
                ...
                <small class="text-danger d-none" id="errDeviceKYC">Select Fingerprint Device</small>

            </div>


            <div class="d-flex justify-content-between mt-4">
                <button class="btn text-white px-4" id="btnCompleteEKYC"
                    style="background: purple;"
                    type="button"
                    onclick="CompleteAgentEKYC()">
                    ✔ Complete EKYC
                </button>
    ...
    <script>
        ...
        function validateEKYC() {
            ...
            showError2("errEkRef", ref === "");
            showError2("errEkycPan", !panRegex.test(pan));
            showError2("errEkycMobile", !mobileRegex.test(mobile));
            showError2("errEkycEmail", !emailRegex.test(email));
            showError2("errEkycAddress", address === "");
            showError2("errEkycCity", city === "");
            showError2("errEkycState", state === "");
            showError2("errEkycPin", !pincodeRegex.test(pincode));
            showError2("errAadhar", !aadhaarRegex.test(aadhaar));
            showError2("errDevice", !device);

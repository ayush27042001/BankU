<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="Calling.aspx.cs" Inherits="NeoXPayout.Calling" %>
...
<br> 
  ...
  <div class="bnk-card-grid" style="margin:10px">
     ...
     <div class="bnk-card">
      ...
      <div class="bnk-card-title">Calling Service Activation</div>
      <div class="bnk-card-desc">
        Enable Calling services at your outlet and stay connected with your customers anytime. 
        With BankU Calling Service, you can handle inquiries, provide support, and improve customer communication effectively.
      </div>

      <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
        <li>Make and receive customer calls instantly</li>
        <li>Dedicated business phone number</li>
        <li>Affordable call rates and plans</li>
        <li>Improve customer support and service quality</li>
        <li>Boost customer trust with professional communication</li>
      </ul>
     <asp:Button 
    ID="btnActivate" 
    runat="server" 
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Calling Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    Activate Calling services and start offering reliable customer communication at your outlet.
  </p>

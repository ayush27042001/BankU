...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="bnk-card-grid" style="margin:10px">
    ...
    <div class="bnk-card-title">Digital Signature Service Activation</div>
    <div class="bnk-card-desc">
      Enable Digital Signature services at your outlet and provide customers with a secure way to sign documents electronically. 
      With BankU Digital Signature, individuals and businesses can ensure authenticity, security, and legal compliance in online transactions.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Issue Class 2 & Class 3 Digital Signatures</li>
      <li>Secure online identity verification</li>
      <li>Legally valid for e-tendering, GST, MCA & IT filings</li>
      <li>Easy to use with USB token or cloud-based signing</li>
      <li>Ensures data integrity & non-repudiation</li>
    </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Digital Signature Service Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
    ...
    <h3 id="bnk-sidebar-title"></h3>
     <p style="margin-bottom: 10px; color: #555;">
      Activate Digital Signature services and help customers sign documents securely and legally online.
    </p>

<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="SoundBox.aspx.cs" Inherits="NeoXPayout.SoundBox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:Label runat="server" ID="lblError" style="margin-left:10px"></asp:Label>
  <div class="bnk-card-grid" style="margin:10px">
    ...
    <div class="bnk-card-title">Sound Box Activation</div>
    <div class="bnk-card-desc">
      Activate Sound Box services at your outlet to get instant audio payment alerts. 
      With BankU Sound Box, you can easily track payments without checking your phone or POS device.
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Instant audio confirmation for customer payments</li>
      <li>Supports UPI, QR & digital wallet transactions</li>
      <li>Clear voice alerts in multiple languages</li>
      <li>Always stay updated without checking the app</li>
      <li>Boost trust with transparent payment confirmation</li>
    </ul>
    ...
    Text="Activate" 
    OnClientClick="openSidebar('Sound Box Activation'); return false;" />
  ...
  <div class="bnk-sidebar" id="sidebar1" >
   ...
   <p style="margin-bottom: 10px; color: #555;">Activate Sound Box service and get instant audio alerts for every payment received.</p>

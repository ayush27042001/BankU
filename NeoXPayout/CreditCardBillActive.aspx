<%@ Page Title="" Language="C#" MasterPageFile="~/Neox.Master" AutoEventWireup="true" CodeBehind="CreditCardBillActive.aspx.cs" Inherits="NeoXPayout.CreditCardBillActive" %>
...
<div class="bnk-card">
    ...
    <div class="bnk-card-title">Credit Card Bill Payment Activation</div>
    <div class="bnk-card-desc">
      Enable Credit Card Bill Payment services at your outlet and help customers pay their credit card bills quickly and securely.  
      With BankU Bill Payment Service, you can provide customers with instant processing, secure transactions, and peace of mind. 
    </div>

    <ul style="font-size: 0.9rem; color: var(--text-light); padding-left: 18px; margin-top: -6px;">
      <li>Instant bill payment processing</li>
      <li>Support for multiple bank credit cards</li>
      <li>Secure digital transactions</li>
      <li>Real-time confirmation of payments</li>
      <li>Convenient outlet-based service</li>
    </ul>
    ...
    <asp:Button 
      ...
      Text="Activate" 
      OnClientClick="openSidebar('Credit Card Bill Payment Activation'); return false;" />
</div>
</div>
